...
<template>
    <section id="contact" class="section bg-light-primary dark:bg-dark-primary py-12">
              ...
              ">
                ...
                ">
                    ...
                    <textarea v-model="form.body" class="textarea" placeholder="Your Meassage"
                        spellcheck="false" cols="55" rows="5"></textarea>
                    <span v-if="form.errors.body" class="text-sm m-2 text-red-400">{{
                        form.errors.body
                    }}</span>

                    <button class="btn btn-lg bg-accent hover:bg-secondary text-white px-4 py-4">
                        Send message
                    </button>
                </form>
            </div>
