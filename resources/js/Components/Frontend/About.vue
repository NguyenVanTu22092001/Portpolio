<template>
    <section id="about" class="section bg-light-secondary dark:bg-dark-secondary">
        <div class="container mx-auto py-12" v-motion :initial="{
            opacity: 0,
            y: 100,
        }" :visible="{
    opacity: 1,
    y: 0,
            ...
            <div class="flex flex-col xl:flex-row gap-24">
                <img class="object-cover h-full w-[566px] md:mx-auto lg:mx-0 rounded-2xl"
                    src="/img/logo-portfolio.jpeg" alt="about" />
                <div class="
                      flex flex-col
                      items-center
                      text-center
                    ...
                    <a href="#contact" class="btn btn-md bg-accent text-light-tail-100 py-4 px-4">
                        Contact me
                    </a>
                </div>
            </div>
