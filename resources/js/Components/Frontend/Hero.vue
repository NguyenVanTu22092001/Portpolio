...
<template>
    <section id="home" class="
              ...
              overflow-hidden
            ">
        <div class="container mx-auto h-full py-12" v-motion :initial="{
            opacity: 0,
            y: 100,
        }" :visible="{
    opacity: 1,
    y: 0,
            ...
            <div class="flex flex-col md:flex-row items-center h-full">
                ...
                <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
                    <img class="rounded-lg" src="https://scontent.fhph1-1.fna.fbcdn.net/v/t1.6435-9/132290018_2834091883585463_2368497279224722374_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=174925&_nc_ohc=V6Ty-CYJh28AX_x2OMG&_nc_ht=scontent.fhph1-1.fna&oh=00_AfCGR0D-idzpTeIBwbKi0eMv7_bjh3Mwz8YDwey1diiX6A&oe=644633B0" alt="Hero" />
                </div>
            </div>
        </div>
    </section>
